...
def button_box(root):
	...
	add_button = Button(button_frame, text='Dodaj Książkę', width=20, command=add_record)
	add_button.grid(row=0, column=0, padx=(13, 10), pady=10)

	update_button = Button(button_frame, text='Edytuj wpis', width=20, command=update_record)
	update_button.grid(row=0, column=1, padx=10, pady=10)

	remove_entries_button = Button(button_frame, text='Usuń wpis', width=20, command=remove_many)
